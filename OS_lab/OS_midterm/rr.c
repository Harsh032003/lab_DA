...
void RoundRobin(Process proc[], int n, int quantum)
{
    ...
    while (completed != n)
    {
        ...
        for (int i = 0; i < n; i++)
        {
            if (currentTime >= proc[i].arrivalTime && remaining[i] > 0)
            {
                allIdle = 0;
    ...
    // while (completed != n)
    // {
    //     int allIdle = 1; // Check if all processes are idle

    //     for (int i = 0; i < n; i++)
    //     {
    //         if (remaining[i] > 0 && proc[i].arrivalTime <= currentTime)
    //         {
    //             allIdle = 0; // At least one process is running
    //             if (remaining[i] > quantum)
    //             {
    //                 currentTime += quantum;
    //                 remaining[i] -= quantum;
    ...
    //     if (allIdle)
    //     {
    //         currentTime++; // Increment time if all processes are idle
    //     }
    // }
