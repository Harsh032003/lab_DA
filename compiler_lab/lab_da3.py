...
term_userdef = ['d', 'a', 'c', 'b', '#']

# Valid input string
valid_input_string = "c c c d"

# Invalid input string
invalid_input_string = "c c c b"
...
# Validate valid input string
print("\nValidating valid input string:")
validity = validateStringUsingStackBuffer(parsing_table, result,
                                          tabTerm, valid_input_string,
                                          term_userdef, start_symbol)
print(validity)

# Validate invalid input string
print("\nValidating invalid input string:")
validity = validateStringUsingStackBuffer(parsing_table, result,
                                          tabTerm, invalid_input_string,
                                          term_userdef, start_symbol)
print(validity)